...
- **Microsoft** for DeBERTa-v3-large
- **OpenAI** for Whisper model
- **SHL** for the interesting challenge!
...
**Uday Bhatia**  
GitHub: [@bhatiauday](https://github.com/bhatiauday)  
Repository: [shl-assessment-ml-code](https://github.com/bhatiauday/shl-assessment-ml-code)
